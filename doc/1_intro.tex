...
%\afterpage{\clearpage}
%\newpage
Existing solutions for detecting malware are mainly classified into router-side schemes \cite{net} and device-side schemes \cite{cfg}.

Router-side schemes pay attention to the fact that there exists strong evidences of malware in network traffic.
